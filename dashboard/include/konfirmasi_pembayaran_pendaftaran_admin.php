        ...
        <div class="card" style="margin-top: 50px">
            ...
            <div class="card-content">
				...
				<table class="table table-hover">
				    ...
				    <tbody>
				    	<?php  
				    		$query 	= "SELECT a.Id, a.status_cicilan, c.email, d.nama,b.Id idd FROM cicilan_pendaftaran a , detail_pendaftaran b, akun c, pendaftaran d WHERE a.id_detail_pendaftaran = b.Id AND a.status_cicilan = 0 AND c.id_user = d.Id AND b.id_user = d.Id ";
