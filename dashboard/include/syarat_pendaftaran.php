                    ...
                    <li> 
                        <?php 
                            ...
                            if ($upload_akte != "" && $upload_kartu_keluarga != "") {
                                ...
                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Fotocopy ijazah dan kartu keluarga 2 lembar<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Fotocopy ijazah dan kartu keluarga 2 lembar<i class="fa fa-check"></i></font>';
                                }else{
                                  echo '<font color="#2ecc71">Fotocopy ijazah dan kartu keluarga 2 lembar<i class="fa fa-check"></i></font> <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                                }

                                
                            }else{
                                echo 'Fotocopy ijazah dan kartu keluarga 2 lembar <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                            }
                    ...
                    <li>
                        <?php 
                            ...
                            if ($foto_anak != "" && $foto_keluarga != "") {
                                ...
                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Pas Foto ukuran 3 x 4 2 lembar<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Pas Foto ukuran 3 x 4 2 lembar<i class="fa fa-check"></i></font>';
                                }else{
                                    echo '<font color="#2ecc71">Pas Foto ukuran 3 x 4 2 lembar<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                                }
                                
                            }else{
                                echo 'Pas Foto ukuran 3 x 4  dan Fotocopy BPJS Kesehatan <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                            }
