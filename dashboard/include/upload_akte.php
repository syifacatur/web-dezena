...
if (isset($_POST['upload'])) {
    ...
    if ($file_type=="application/pdf" || $file_type=="image/png" || $file_type=="image/jpeg") {
...

         {
            ...
            if ($exec) {
             echo "<div class='alert alert-success alert-dismissable'>
              ...
              <strong>Berhasil!</strong> Upload Ijazah(PDF).
            </div>";   
            }
         ...
         echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload Ijazah(PDF).
        </div>";
     ...
     echo "<div class='alert alert-danger alert-dismissable'>
          <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
          <strong>Gagal!</strong> Upload ijazah harus format(PDF).
        </div>";
    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Upload Ijazah(PDF, JPEG, PNG) dan Kartu Keluarga(PDF, JPEG, PNG)</h4>
