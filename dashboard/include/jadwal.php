...
?>
<a href="index.php?page=23&kelas=A" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas </a>
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Jadwal Kelas Tata Busana</h4>
...
<a href="index.php?page=23&kelas=B" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas </a>

<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Jadwal Kelas Rekayasa Perangkat Lunak</h4>
...
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Jadwal Kelas Tata Boga</h4>
                <p class="category">Daftar Mata Pelajaran </p>
            </div>
            <div class="card-content">
                <div class="row">
