            ...
            <div class="card-content">
            	...
            	<ul>
        			...
        			<?php
                        ...
                        if ($kelas == "Tata Busana") {
                            ...
                            if ($nom >= 1500000) {
                                ...
                                if ($laststatus == 0) {
                                    ...
                                    echo '<li><a href="index.php?page=15" class="close">Konfirmasi pembayaran pendaftaran(Lunas)</a></li>';
                                }
                        ...
                        if ($kelas == "Kelas Rekayasa Perangkat Lunak") {
        			...
        			<?php	
        			}else if($daftar['status_pendaftaran'] == 5){
